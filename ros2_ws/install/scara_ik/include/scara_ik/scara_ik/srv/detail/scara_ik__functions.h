...
#ifndef SCARA_IK__SRV__DETAIL__SCARA_IK__FUNCTIONS_H_
#define SCARA_IK__SRV__DETAIL__SCARA_IK__FUNCTIONS_H_
...
/// Initialize srv/ScaraIK message.
/**
 ...
 * )) before or use
 * scara_ik__srv__ScaraIK_Request__create()
...
/// Create srv/ScaraIK message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * scara_ik__srv__ScaraIK_Request__init().
...
/// Destroy srv/ScaraIK message.
/**
 * It calls
 * scara_ik__srv__ScaraIK_Request__fini()
...
/// Check for srv/ScaraIK message equality.
/**
...
/// Initialize array of srv/ScaraIK messages.
/**
...
/// Finalize array of srv/ScaraIK messages.
/**
 * It calls
 * scara_ik__srv__ScaraIK_Request__fini()
...
/// Create array of srv/ScaraIK messages.
/**
 * It allocates the memory for the array and calls
 * scara_ik__srv__ScaraIK_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ScaraIK messages.
/**
 * It calls
 * scara_ik__srv__ScaraIK_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ScaraIK message array equality.
/**
...
/// Copy an array of srv/ScaraIK messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * scara_ik__srv__ScaraIK_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_ik
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * scara_ik__srv__ScaraIK_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_ik
...
/**
 * It calls
 * scara_ik__srv__ScaraIK_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_ik
...
/**
 * It allocates the memory for the array and calls
 * scara_ik__srv__ScaraIK_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_ik
...
/**
 * It calls
 * scara_ik__srv__ScaraIK_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * scara_ik__srv__ScaraIK_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_ik
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * scara_ik__srv__ScaraIK_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_ik
...
/**
 * It calls
 * scara_ik__srv__ScaraIK_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_ik
...
/**
 * It allocates the memory for the array and calls
 * scara_ik__srv__ScaraIK_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_ik
...
/**
 * It calls
 * scara_ik__srv__ScaraIK_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SCARA_IK__SRV__DETAIL__SCARA_IK__FUNCTIONS_H_
